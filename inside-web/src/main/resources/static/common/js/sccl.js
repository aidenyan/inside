...
$(".side-menu").on('click', 'li a', function (e) {
    ...
    addIframe(h, m, label,url,undefined,true);
});

/*添加iframe*/
function addIframe(h,m,label,url,reflush,funResult) {
     var   isHas = false;
   ...
   /* var fullWidth = $(window).width();
    if (fullWidth >= 750) {
        ...
        $(".mizone-side-arrow").addClass("close");
    ...
    if (!isHas) {
        var tab = "<a href='javascript:;' class='content-tab active' data-id='" + h + "'>" + label + " <i class='icon-yuejuancuohao'></i></a>";
        ...
        if(Utils.isNotBlack(h)){
            try{
                callChild.useRegister(h,"search");
                callChild.useRegister(h,"refresh");
            }catch(e){
                try{
                    callChild.useRegister(h,"refresh");
                }catch(e){
        ...
        try {
            if (item.isHeader == "1") {
                ...
                if (item.childMenus == "") {
                    ...
                    str = "<li><a href='" + item.url + "'  code='"+item.code+"'><span>" + item.name + "</span></a></li>";
                    $(parent).append(str);
                } else {
...
/*$(".header-menu-btn").click(function () {
    ...
    $(".mizone-main").removeClass("full-page");
    $(".mizone-footer").removeClass("full-page");
    $(".mizone-side-arrow").removeClass("close");
    $(".mizone-side-arrow-icon").removeClass("close");

    $(".mizone-side").slideToggle();
});*/
...
$(function () {
    ...
    /*菜单json*/
    /*var menu = [{
        "id": "1", "name": "主菜单", "parentId": "0", "url": "", "icon": "", "isHeader": "1",
        "childMenus": [
            {
                "id": "3",
                "name": "商品管理",
                ...
                "childMenus": [
                    {
                        ...
                        "name": "组织架构管理",
                        "parentId": "040",
                        "url": "user/user_organizational.html",
                        "icon": "",
