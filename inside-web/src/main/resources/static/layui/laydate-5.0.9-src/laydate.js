...
;!function(){
  ...
  */
  ...
  laydate.now = function(e, t){
        ...
        return laydate.parse([a.getFullYear(), a.getMonth() + 1, a.getDate()], [a.getHours(), a.getMinutes(), a.getSeconds()], t)
	};
	laydate.parse = function(e, t, s) {
        return e = e.concat(t),
        s = s || (options ? options.format: a.format),
        s.replace(/YYYY|MM|DD|hh|mm|ss/g,
        function(t, a) {
            return e.index = 0 | ++e.index,
            laydate.digit(e[e.index])
        })
    };
	laydate.digit = function(e) {
        return e < 10 ? "0" + (0 | e) : e
    };
  //暴露lay
