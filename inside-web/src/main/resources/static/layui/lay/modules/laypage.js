...
;layui.define(function (a) {
    ...
    p.on = function (a, t, e) {
        ...
        for (t.groups > t.pages && (t.groups = t.pages), r.index = Math.ceil((t.curr + (t.groups > 1 && t.groups !== t.pages ? 1 : 0)) / (0 === t.groups ? 1 : t.groups)), e.push('<a href="javascript:;" class="laypage_first" data-page="1"  title="&#x9996;&#x9875;">' + t.first + "</a><!--<span>&#x2026;</span>-->"), e.push('<a href="javascript:;" class="layui-laypage-prev" data-page="' + (t.curr - 1) + '">' + t.prev + "</a>"),  r.poor = Math.floor((t.groups - 1) / 2), r.start = r.index > 1 ? t.curr - r.poor : 1, r.end = r.index > 1 ? function () {
        ...
        return /*t.pages > t.groups && r.end < t.pages && t.last && 0 !== t.groups &&*/  /*r.flow = !t.prev && 0 === t.groups, ( t.next || r.flow) &&*/ e.push(function () {
        ...
        }()),e.push('<!--<span>&#x2026;</span>--><a href="javascript:;" class="layui-laypage-last" title="&#x5C3E;&#x9875;"  data-page="' + t.pages + '">' + t.last + "</a>"), '<div class="layui-box layui-laypage layui-laypage-' + (t.skin ? function (a) {
                return /^#/.test(a) ? "molv" : a
            }(t.skin) : "default") + '" id="layui-laypage-' + a.config.item + '">' + e.join("") + function () {
            return t.skip ? '<span class="layui-laypage-total">&#x5230;&#x7B2C; <input type="number" min="1" onkeyup="this.value=this.value.replace(/\\D/, \'\');" value="' + t.curr + '" class="layui-laypage-skip"> &#x9875; <button type="button" class="layui-laypage-btn">&#x786e;&#x5b9a;</button><button type="button" class="layui-laypage-btn">共'+t.pages+'页</button></span>' : ""
        }() + "</div>"
